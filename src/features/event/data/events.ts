...
export const Events: Event[] = [
    ...
    },
    {
        ...
        image: true,
        content:
            '<p>You are trailed and attacked by a group of bandits. There are 1d6+2 of them, each with E 1d6+2, M4, H4, armed with sidearms (see R210 for tech level). Refer to R327 for the combat situation.</p>',
    },
    {
        tag: 'e014',
        title: 'Gamblers',
    ...
    },
    {
        ...
        image: true,
        content:
            '<p>If you have personal and ship’s papers (R228), are not “wanted” in this system (R228), and do not have any items purchased on Mynkuria, the Nipnans help extricate your ship and you are free to proceed. Any crewman with you but without papers is arrested and lost.</p><p>Otherwise, with their overwhelming force of warships, they confiscate everything you own, including your starship and cargo, and put you and your crew in jail, see E023. Boy, you really blew it this time!</p>',
    },
    {
        tag: 'e025',
    ...
    },
    {
        ...
        time: 'No time',
        content:
            '<p>You run into a trap designed to stop your vehicle. Roll 1d6:</p><p>1-2: the vehicle suffers that many hits of damage (R217)</p><p>3-5: it suffers an immediate break-down but not hits</p><p>6: the trap malfunctions and has no effect upon your vehicle</p>',
    },
    {
        tag: 'e078',
    ...
    },
    {
        ...
        time: 'takes no time',
        content:
            '<p>An impressively large Imperian warship, bristling with guns, orders you to stop, take aboard an Imperian pilot to direct your planetary approach and to receive required visas and entry permits. Your options are:</p><p>To immediately hyperjump to another system (R212A);</p><p>To attack or flee the battleship, space combat (R230L) will result, see E081 for details;</p><p>To acknowledge and let the boarding party come aboard, see E403.</p>',
    },
    {
        tag: 'e115',
    ...
    },
    {
        ...
        time: 'no time',
        content:
            '<p>You encounter a hostile life force — a greenish glowing cylinder of energy. Your vehicles and robots (if any) immediately break down (R219). The life force has Endurance 5, and appears to be trying to contact and engulf individuals, to destroy them. You may:</p><p>Fire weapons at it — see E163</p><p>Attack it hand-to-hand — see E170</p><p>Abandon your vehicle and flee — see E176</p><p>Feed it life support units (decide how many now) — see E194</p><p>Stand and let it engulf you — see E187</p>',
    },
    {
        tag: 'e136',
    ...
    },
    {
        ...
        time: '1 hour',
        content:
            '<p>Each of the small ships collides with your starship and explodes. Each inflicts two hits of damage. ECM does not help you, but if defensive screens exist and are energized, roll 1d6 for each attacker:</p><p>1-3 it hits screens</p><p>4-6 it hits ship and penetrates screens to inflict one hit of damage</p>',
    },
    {
        tag: 'e166',
...

    {
        ...
        time: '1 hour',
        content:
            '<p>You have wandered into a battle between Nipna and Mynkuria, and inadvertently get involved. Roll 1d6:</p><p>1-3 - see E098</p><p>4-6 - see E107</p>',
    },
    {
        tag: 'e175',
        title: 'Palace Sentry',
    ...
    },
    {
        ...
        time: 'rest of day',
        content:
            '<p>If you have a ship’s boat or starship, you can spend one hour to climb to orbit (R214 in boat, R212G in starship). Otherwise, follow this result: You have lost your way. At the end of the day, roll 1d6:</p><p>1-3 - You determine your location at night by starlight, no further effect.</p><p>4-6 - You are unable to locate yourself, you are lost throughout tomorrow (the day is wasted), then roll 1d6 again and use these same results again.</p>',
    },
    {
        tag: 'e179',
    ...
    },
    {
        ...
        time: 'no time',
        content:
            '<p>Although the probes could not gather specific information, the psionicist for the New Karman Defense Force has learned your personal identity. You are now “wanted” (R228) in the New Karma system, regardless of any crimes or contraband.</p>',
    },
    {
        tag: 'e187',
        ...
        time: 'rest of day',
        content:
            '<p>The life force wraps around you in painful greenish light. Roll 1d6:</p><p>1–4 – You are dead. Lose the game.</p><p>5–6 – The life force merges with you, permanently adding its current Endurance to yours. It then dissipates into a wispy green cloud.</p>',
    },
    {
        tag: 'e188',
    ...
    },
    {
        ...
        time: '1 hour',
        content:
            '<p>You may feed it any number of LSUs. It gains 1 Endurance per LSU. Roll 1d6:</p><p>If the result is less than the number of LSUs, it dissipates peacefully into mist</p><p>If the result is a 6, it engulfs one person (random); see E187 for effect</p><p>Then return to E135 and choose another option.</p>',
    },
    {
        tag: 'e195',
    ...
    },
    {
        ...
        time: 'no time',
        content:
            '<p>You attempt a bribe. Roll 1d6:</p><p>1: They accept it and let you pass.</p><p>2: They demand triple what you offered — if paid, they let you pass.</p><p>3: They demand 1d6 × 1,000 S — if paid, they let you pass.</p><p>4–6: They refuse. If you cannot bribe them, they open fire — see E428.</p>',
    },
    {
        tag: 'e407',
    ...
    },
    {
        ...
        content:
            '<p>You engage in battle with a scout ship. You fire first, then it retaliates. Battle continues (R230L) until one ship is destroyed or escapes. If you try to flee, the scout pursues. Scout has 2 hit points, a tech 6 turret gun, and a magneto-plasma nose gun (fires once first turn, then recharges on 5-6). The plasma gun kills all in one compartment per hit (roll 1d6):</p><p>1: pilot’s compartment</p><p>2: crew quarters</p><p>3: engineering</p><p>4: gun turret</p><p>5: main cargo hold</p><p>6: boat hold and ship’s boat</p>',
    },
    {
        tag: 'e423',
    ...
    },
    {
        ...
        time: '1 hour',
        content:
            "<p>You discover whether the escapee fulfilled his promise. Roll 1d6:</p><p>1-2: He slips away in a crowd and you never see him again.</p><p>3: He has no wealth but offers 40 S, all he has.</p><p>4: He has no money but offers valuable underworld connections, providing false papers for you and your crew.</p><p>5: He thanks you and pays you 1,500 S.</p><p>6: He’s from a wealthy family and pays you 4,000 S now, with 4,000 S each week for the rest of your life. Payments are to a local bank account, continuing until you're proven dead to the bank.</p>",
    },
    {
        tag: 'e428',
        ...
        time: '2 hours',
        content:
            '<p>After an hour, the scout acts. Roll 1d6:</p><p>1-2: He gives a friendly warning and disappears rapidly.</p><p>3-6: He opens fire. You can either return fire or instantly escape (if still able). For the effect of his fire, and resolving any space battles, see E422.</p>',
    },
    {
        tag: 'e429',
